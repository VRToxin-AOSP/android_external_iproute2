...
LOCAL_CLANG := false
LOCAL_SRC_FILES := utils.c rt_names.c ll_types.c ll_proto.c ll_addr.c inet_proto.c namespace.c dnet_pton.c mpls_ntop.c mpls_pton.c ipx_ntop.c dnet_ntop.c names.c color.c libgenl.c libnetlink.c
